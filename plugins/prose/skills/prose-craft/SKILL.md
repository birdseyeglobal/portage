...
| **Graham Essays**   | `references/graham-essays.md`   | Writing essays, blog posts, opinion pieces, or thought-leadership content in a first-person, thesis-driven, direct register. When the user asks for a "Paul Graham" or "essay" voice, or when the voice discovery process identifies the genre as personal essay or argument essay. | The task is not essay-form writing. The user has specified a different voice or register. Technical documentation, formal reports, or collaborative documents where the personal-essay register would be inappropriate. |
