# AI-Writing Word Choice

Companion to `humanizer-patterns.md` / Signs of AI Writing. Use this file for
word-level cleanup after identifying the broader artifact pattern.
