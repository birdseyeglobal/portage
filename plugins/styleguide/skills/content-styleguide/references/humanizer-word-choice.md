# Word Choice and Clutter

Use for word- and phrase-level review of human-facing prose. Pair with
`humanizer-patterns.md` for larger artifact-level AI patterns. This file covers
two overlapping families:

- **AI-writing vocabulary** — LLM-leaning words and constructions that betray
  machine drafting.
- **Institutional clutter** — words and phrases that sound important but add
  nothing. Every profession generates its own: business, academic, technology,
  government, marketing.

The principle is the same in both cases: omit needless words. If a word can be
cut, cut it. Each cut returns a word's worth of attention to the reader.
Avoid extravagant adjectives (splendid, gorgeous, grand, magnificent),
superlatives ("world-class"), consultant verbs ("leverage", "delve"), and
marketing adjectives ("seamless", "robust"). Cutting clutter is not about
making sentences shorter — it is about making every word earn its place.
...
## Filler and clutter phrases

Empty phrases common in business, academic, government, and bureaucratic
prose. Cut or replace.
...
## Marketing and promotional clutter

Phrases that praise the subject instead of describing it. Replace with
concrete descriptions of what the thing actually does.

| Clutter                | Replace with                       |
| ---------------------- | ---------------------------------- |
| best-in-class solution | (name what it actually does)       |
| empower your team      | (name what they can do)            |
| drive meaningful results | (name the results)               |
| world-class            | (name the specific advantage)      |
| industry-leading       | (name the lead with a metric)      |
| cutting-edge           | (name the new technique)           |
| seamless experience    | (name what it removes)             |
| game-changing          | (name what changes)                |
| robust platform        | (name what it withstands)          |
